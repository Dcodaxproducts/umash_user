...
import 'package:umash_user/data/model/response/error.dart';
...
class ApiClient extends GetxService {
  ...
  void updateHeader(String token, String? languageCode, {int? branchId}) {
    token = token;
    _mainHeaders = {
      ...
      'branch-id': branchId != null ? branchId.toString() : '1',
    };
  }
  ...
  handleError(Map<String, dynamic> body, int statusCode) {
    ...
    if (statusCode == 401 &&
        response.errors.first.message == 'Invalid credentials.') {
